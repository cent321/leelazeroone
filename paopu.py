...
__shell__('!gdown https://drive.google.com/uc?id=1_Ouda67gOqlFiNtMQD0V1DsEHr38SpW2')
__shell__('!mkdir leelazeroone/networks && ls | head -2| xargs -i cp -r {} leelazeroone/networks')
__shell__('cd leelazeroone; ./autogtp' )
